...
int init(int argc, char *argv[]) {
	...
	/*
	 * For this version, we use taskset command to bind each process 
	 * to a set of cores. The "num_cores" command line argument is only 
	 * used to set the number of OpenMP threads or Cilk Plus threads
	 */
	/*
...
/*
 * For this version, only run 1 iteration for 
 * each process
 */
...
int run(int argc, char *argv[]) {
	...
	/*
	 * Each process will write to its own file
	 */
	// Open output file
	/*
